...
function App() {
  console.log("API_URL desde config/api:", API_URL);
  console.log("process.env.REACT_APP_API_URL:", process.env.REACT_APP_API_URL); // Configurar interceptor para manejar tokens y redireccionar en caso de 401
  React.useEffect(() => {
